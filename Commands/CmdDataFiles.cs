  ...
  static class CmdDataFiles {
    ...
    public static void Farmer(CommandContext bc) {
      ...
      if (plant == null) {
        ...
        string reply = @"Plant: \c07{0}\c | Level: \c07{1}\c | Exp: \c07{2:#,##0.#}\c | Patch: \c07{3}\c | Seed: \c07{4}\c (\c07{5:N0} gp\c) | Produce: \c07{6}\c (\c07{7:N0} gp\c) | Plant xp: \c07{8:#,##0.#}\c".FormatWith(
    ...
    public static void Pouch(CommandContext bc) {
      ...
      if (familiar == null) {
        ...
        bc.SendReply(@"Familiar: \c{0}{1}\c | Level: \c{0}{2}\c | Exp: \c{0}{3:#,##0.#}\c | Time: \c{0}{4} min\c | Charm: \c{0}{5}\c | Components: \c{0}{6}\c (\c{0}{7:N0} gp\c) | Abilities: \c{0}{8}\c".FormatWith(
        ...
        bc.SendReply(@"Shards: \c{0}{1:N0}\c (\c{0}{2:N0} gp\c) | Cost: \c{0}{3:N0}\c (\c{0}{4:0.#}/xp\c) | Bogrog cost: \c{0}{5:N0}\c (\c{0}{6:0.#}/xp\c) | High alch: \c{0}{7:N0}\c (\c{0}{8:0.#}/xp\c) | Market price: \c{0}{9:N0}\c (\c{0}{10:0.#}/xp\c)".FormatWith(
    ...
    public static void Charms(CommandContext bc) {
      ...
      bc.SendReply(@"\b{0}\b summoning level \c07{1}\c | \c07{2:N0} Gold\c; \c03{3:N0} Green\c; \c04{4:N0} Crimson\c; \c10{5:N0} Blue\c | Total exp: \c07{6:#,##0.#}\c | Total shards: \c07{7:N0}\c (\c07{8:N0} gp\c) | Expected level: \c07{9}\c (\c07{10:N0} xp\c)".FormatWith(
    ...
    public static void Potion(CommandContext bc) {
      ...
      if (potion == null) {
        ...
        bc.SendReply(@"Potion: \c07{0}\c (\c07{1:N0} gp\c) | Level: \c07{2}\c | Exp: \c07{3:#,##0.#}\c | Ingredients: \c07{4}\c | Total cost: \c07{5:N0} gp\c (\c07{6:0.#}/xp\c) | Effect: \c07{7}\c".FormatWith(
    ...
    public static void Spell(CommandContext bc) {
      ...
      if (spell == null) {
        ...
        if (spell.MaxHit == 0) {
          bc.SendReply(@"Spell: \c07{0}\c | Level: \c07{1}\c | Exp: \c07{2:#,##0.#}\c | Book: \c07{3}\c | Runes: \c07{4}\c | Total cost: \c07{5:N0} gp\c (\c07{6:0.#}/xp\c) | Effect: \c07{7}\c".FormatWith(
          ...
          bc.SendReply(@"Spell: \c07{0}\c | Level: \c07{1}\c | Exp: \c07{2:#,##0.#} - {3:#,##0.#}\c | Book: \c07{4}\c | Max hit: \c07{5}\c | Runes: \c07{6}\c | Total cost: \c07{7:N0} gp\c (\c07{8:0.#}/xp - {9:0.#}/xp\c) | Effect: \c07{10}\c".FormatWith(
