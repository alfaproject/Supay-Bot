...
namespace BigSister.Irc.Messages {
  /// <summary>
  ///   The reply to a <see cref="ClientInfoRequestMessage"/>, giving the human-readable response to the request. </summary>
  [Serializable]
  class ClientInfoReplyMessage : CtcpReplyMessage {
